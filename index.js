    ...
    adon.ev.on('group-participants.update', async (anu) => {
        ...
        try {
            ...
            for (let num of participants) {
                ...
                nt = `*`
                text_in = `
${nt}SELAMAT DATANG @${num.split("@")[0]} DI ${metadata.subject} 
*~BOT WEBP AUTO CREATE~*
*~TAMPILAN WEBP~*
1.mobile legend                   
2.codashop        
3.freefire
 ...
 *KE UNTUNGAN BISA DAPAT* *CUAN DAN AUTO CREATE*
*TUTOR NYA CEK VIDIO DI BAWAK👇🏾👇🏾👇🏾*
[https://youtu.be/z6CNtupjECM]
`

                    adon.sendMessage(anu.id, { image: { url: ppuser }, contextInfo: { mentionedJid: [num] }, caption: `${text_in}` })
                } else if (anu.action == 'remove') {
                    text_out = `
${nt}@${num.split("@")[0]} TELAH KELUAR DARI ${metadata.subject} 
*~BOT WEBP AUTO CREATE~*
*~TAMPILAN WEBP~*
1.mobile legend                   
2.codashop        
